class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    # config.add_index_field solr_name("archival_collection", :stored_searchable), label: "Archival Collection"
    # config.add_index_field solr_name("condition", :stored_searchable), label: "Condition Notes"
    ...
    config.add_sort_field "system_title_dtsi asc", label: "title (A-Z)"
