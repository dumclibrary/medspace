...
describe HandleRegistrar do
  ...
  let(:stubbed_connection) do
    ...
    Class.new do
      ...
      # respond to everything and do nothing.
  ...
  describe '#register!' do
    ...
    it 'generates different handles for different objects' do
      other = Image.new(title: ['Comet in Moominland'], id: 'fake_snork')
